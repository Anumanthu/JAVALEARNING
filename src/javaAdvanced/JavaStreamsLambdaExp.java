...
public class JavaStreamsLambdaExp {
    ...
    public static void main(String[] args) {
        ...
        //filter,map,anyMatch,allMatch,forEach,limit,collect(Collectors.toList()) etc Streams utility methods/helpers
        ...
        listInt.stream().distinct().sorted().toList().forEach(s -> System.out.println(" " + s));

        listInt.stream().distinct().sorted(Comparator.reverseOrder()).collect(Collectors.toList()).forEach(s -> System.out.println(" " + s));
